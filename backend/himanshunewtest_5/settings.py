"""
Django settings for himanshunewtest_5 project.
...
ROOT_URLCONF = 'himanshunewtest_5.urls'
...
WSGI_APPLICATION = 'himanshunewtest_5.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "himanshunewtest_5 API",
    "DESCRIPTION": "API documentation for himanshunewtest_5 App",
    "VERSION": "v1",
}
